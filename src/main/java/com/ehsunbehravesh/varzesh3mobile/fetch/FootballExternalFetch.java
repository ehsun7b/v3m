 ...
 * @author ehsun7b
 */
public class FootballExternalFetch {

  private static final String URL = "http://www.varzesh3.com/files/leftnewsFootExt.asp";
  ...
  public List<News> fetch() throws IOException {
    ...
    for (Element link : links) {
      ...
      News news = new News();
      news.setUrl(url);
      news.setCategory(News.CAT_FOOTBALL_EXTERNAL);
